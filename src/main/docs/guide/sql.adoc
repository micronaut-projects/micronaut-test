...
[source,sql]
----
include::test-junit/src/test/resources/create.sql[]
----
...
[source,sql]
----
include::test-junit/src/test/resources/datasource_1_insert.sql[]
----
...
----
include::{junittests}/SqlDatasourceTest.java[tags="clazz"]
----
...
[source, java, role="multi-language-sample"]
----
include::{junittests}/SqlNamedDatasourceTest.java[tags="clazz"]
----
