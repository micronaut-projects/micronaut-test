A small utility module exists that helps integrating the REST-assured library. Simply add the following dependency:

dependency:micronaut-test-rest-assured[groupId="io.micronaut.test"]
