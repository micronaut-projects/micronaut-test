...
> **_NOTE:_**  KotlinTest for Micronaut is deprecated in favour of Kotest (see next section https://micronaut-projects.github.io/micronaut-test/latest/guide/#kotest)[Testing with Kotest])
