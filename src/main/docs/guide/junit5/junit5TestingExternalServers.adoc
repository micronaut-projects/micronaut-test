...
snippet::io.micronaut.test.junit5.server.ProcessServerTest[project="test-junit5", language="java", tags="executable", title="Using `micronaut.test.server.executable`"]
