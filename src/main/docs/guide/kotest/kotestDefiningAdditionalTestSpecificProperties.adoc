...
snippet::io.micronaut.test.kotest5.PropertyValueTest[project="test-kotest5", language="kotlin", title="Using `@Property`"]
...
snippet::io.micronaut.test.kotest5.PropertySourceTest[project="test-kotest5", language="kotlin", title="Using `propertySources` stored in files"]
