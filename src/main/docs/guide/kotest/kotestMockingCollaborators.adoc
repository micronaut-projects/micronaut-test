...
snippet::io.micronaut.test.kotest5.MathController[project="test-kotest5", language="kotlin", title="The MathController"]
...
snippet::io.micronaut.test.kotest5.MathCollaboratorTest[project="test-kotest5", language="kotlin", title="Mocking Collaborators"]
