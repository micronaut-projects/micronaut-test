...
** `io.micronaut.test.extensions.junit.annotation.MicronautTest` for JUnit.
...
----
include::test-junit/src/test/java/io/micronaut/test/junit/EagerInitializationTest.java[tags=eager, indent=0]
----
